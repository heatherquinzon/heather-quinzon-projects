...
public class Products {
    ...
    public BigDecimal getLaborCosterPerSquareFoot() {
    ...
    public int hashCode() {
        ...
        hash = 17 * hash + Objects.hashCode(this.laborCosterPerSquareFoot);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.laborCosterPerSquareFoot, other.laborCosterPerSquareFoot)) {
            return false;
        }
        return true;
    }
