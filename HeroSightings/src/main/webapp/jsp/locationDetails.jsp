...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>
                <b>Name:</b> <c:out value="${location.name}"/>
            </p>
            <p>
                <b>Description:</b> <c:out value="${location.description}"/>
            </p>
            <p>
                <b>City:</b> <c:out value="${location.city}"/>
            </p>
            <p>
                <b>State (Initial):</b> <c:out value="${location.stateInitial}"/>
            </p>
            <p>
                <b>Zipcode:</b> <c:out value="${location.zipcode}"/>
            </p>
            <p>
                <b>Longitude:</b> <c:out value="${location.longitude}"/>
            </p>
            <p>
                <b>Lattitude:</b> <c:out value="${location.lattitude}"/>
            </p>
